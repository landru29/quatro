...
THREE.TrackballControls = function(object, domElement) {
	...
	/*********************************************************/
	this.enableNavigation = function(state) {
		this.enabled = state;
		removeContextMenu(this.domElement, state);
	};
	/*********************************************************/
	...
	var removeContextMenu = function(dom, state) {
		if (state) {
			dom.addEventListener('contextmenu', contextMenu, false);
		} else {
			dom.removeEventListener('contextmenu', contextMenu, false);
		}
	};

	removeContextMenu(this.domElement, true);
